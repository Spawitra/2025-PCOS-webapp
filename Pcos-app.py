...
st.sidebar.warning("⚠️ แบบประเมินนี้เป็นเพียงการประเมินเบื้องต้น ❌ ไม่ใช่การวินิจฉัยทางการแพทย์ หากผลการประเมินพบว่ามีความเสี่ยง ควรพบแพทย์ผู้เชี่ยวชาญ เช่น แผนกนรีเวช หรือสูติ-นรีเวช ของโรงพยาบาลใกล้บ้าน ")
