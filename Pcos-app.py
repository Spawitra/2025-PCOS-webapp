...
with st.container():
    ...
    with col1:
        ...
        cycle_length = st.number_input("🗓️ Cycle length (days) ต่อรอบเดือนประจำเดือนมากี่วัน", caption="หากผู้ประเมินมีประจำเดือนมามากกว่าเกณฑ์การประเมินที่ 1-15 วัน ห ควรปรึกษาผู้เชี่ยวชาญ", min_value=1, max_value=15, value=7)
