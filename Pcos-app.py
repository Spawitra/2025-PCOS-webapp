...
with st.container():
    ...
    with col1:
        ...
        st.warning("การประเมินความเพิ่มขึ้นของขนตามจุดต่างๆ หากจากเดิมอยู่ที่ ความหนาอยู่ที่ระดับ 1 แล้วช่วงที่ผ่านมาสังเกตว่าเพิ่มเป็นระดับ 2 หรือ ระดับ 3 ถือว่าเพิ่มขึ้น")
