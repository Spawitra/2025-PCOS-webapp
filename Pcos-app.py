...
st.warning("⚠️แบบประเมินความเสี่ยงนี้เป็นเพียงการประเมินเบื้องต้น
...
with col1:
    ...
    cycle_length = st.number_input("Cycle length (days) รระยะห่างต่อรอบ ", min_value=15, max_value=60, value=28)
with col2:  
...
with col3:
    ...
    foll_r = st.radio("รูขุมขนบนหน้า ขวา ", min_value=0, ["Y", "N"])
