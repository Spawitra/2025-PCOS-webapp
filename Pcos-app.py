...
with st.container():
    ...
    with col1:
        ...
        cycle_length = st.number_input("🗓️ Cycle length (days) ต่อรอบเดือนประจำเดือนมากี่วัน", min_value=1, max_value=15, value=7)
        st.caption.write("หากผู้ประเมินมีประจำเดือนมามากกว่าเกณฑ์การประเมินที่ 1-15 วัน ควรปรึกษาผู้เชี่ยวชาญ")
